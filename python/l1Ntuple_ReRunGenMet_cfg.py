...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string('L1TreeGen.root')
)

# ReRun GenMet
process.load("L1TriggerDPG.L1Ntuples.rerunGenMet_cfi")
...
process.load("L1TriggerDPG.L1Ntuples.l1GenTreeProducer_cfi")
